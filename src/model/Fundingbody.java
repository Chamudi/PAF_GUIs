...
{ //A common method to connect to the DB
	...
	public String insertSponcer(String nic, String fname, String lname, String email,String phoneno)
	{
		...
		try
		{
			...
			String query = " insert into sponcers(sponcerNIC,sponcerFname,sponcerLname,sponcerEmail,sponcerPhoneNo)"+ " values (?, ?, ?, ?,?)";
	...
	public String deleteSponcer(String sponcerId)
	{
		...
		try
		{
			...
			preparedStmt.execute();
			con.close();
			String newSponcer = readSponcers();  
		    output = "{\"status\":\"success\", \"data\": \"" + newSponcer + "\"}";
			//output = "Deleted successfully";
		}
		catch (Exception e)
		{
			output = "{\"status\":\"error\", \"data\": \"Error while deleting the sponcer.\"}";
	        System.err.println(e.getMessage());
